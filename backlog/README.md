...
ADR-0043), the alignment sweeps (`19`, ALN-1–5 — docs locked at v0.4,
`docs/sweeps/` holds both reports), the four sweep-surfaced fixes (`PKM-11`,
`PKM-12`, `ADM-6`, `SIM-11`, PRs #123–#126), mobile-feel round two
(`MOB-3`, `MOB-5`–`MOB-8`: view transitions, pull-to-refresh, bottom-sheet
confirms, pick-save haptic, Android install instructions), league dues (`20`),
and the override removal (`21`, OVR-1–5 — remove the manual sports-data override
layer, ADR-0046, PRs #143 onward).
