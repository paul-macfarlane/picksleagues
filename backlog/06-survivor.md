...
- [~] **ELM-1** — `SurvivorSettings` Zod schema (SU/ATS, push/tie resolution: advance-and-consume vs eliminate; resolved regular-season week range stored, not chosen) + settings form. _(deps: LG-2, SIMP-18)_
