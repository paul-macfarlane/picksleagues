...
- [ ] **LNCH-6** — Dark mode: light/dark/system theme toggle with persisted preference; sweep every screen in both themes to verify the token system holds (no hard-coded colors slipped through). _(deps: FND-1)_
