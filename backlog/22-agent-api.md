...
- [ ] **AGENT-3** — Specify diagnostic-assisted repairs: eligible discrepancies, human approval/preview, separate write authorization, audit, concurrency, retry/refusal and recovery rules. Owner approved scheduled diagnostics, deduplicated incidents and tested fix PRs with human merge; discovery is AGENT-4, runner integration follows separately. [Notion idea](https://app.notion.com/p/3dbc4dbb62178194a44fd59fda09304f). _(deps: AGENT-2)_ _(ready-for-agent)_

- [x] **AGENT-4** — Add bounded paginated NFL league-season discovery for monitoring: season pinned from `/system`, UUID cursor, at most 100 results, technical league-season ID/mode/status only, includes concluded leagues. No member/pick data, scheduler or repairs. Part of [the approved monitoring design](https://app.notion.com/p/3dbc4dbb62178194a44fd59fda09304f). _(deps: AGENT-2)_ _(ready-for-agent)_
