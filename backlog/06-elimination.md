...
> prefix; the rename ADR plus the spec/arch/backlog sweep (this file →
> `06-survivor.md`, epic title, ticket wording, `LEAGUE_MODE` value + data
> migration) ships with ELM-1. Member-state vocabulary — alive, eliminated,
> revived — is unchanged.
