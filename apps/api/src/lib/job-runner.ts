 ...
 * are triggered by an external scheduler and may be re-run or double-fired
 * (a missed tick, a manual re-trigger from the admin page), so `fn` should
 * be safe to execute more than once with the same effect as once.
 *
