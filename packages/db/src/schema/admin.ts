...
/**
 * Operator action log (arch §Domain Model: "admin_audit — override/rebuild
 * actions: admin, action, target, prior value, at"; engineering rules §Data:
 * "every override/rebuild writes `admin_audit`"). Cross-cutting admin
...
export const adminAudit = pgTable("admin_audit", {
  ...
  // JSONB, because "prior value" has a different shape per action (a game
  // override's five columns today, a rebuild's scope tomorrow) and the audit
